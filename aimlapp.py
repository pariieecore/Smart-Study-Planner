...
if st.button("Generate Study Plan"):
    ...
    for subject, topics in subjects.items():
        ...
        for t in topics:
            ...
            all_tasks.append({"subject": subject, "topic": t["topic"], "priority": t["priority"], "hours": hours_needed})
    ...
    for task in all_tasks:
        ...
        while hours_left > 0:
            ...
            if available > 0:
                ...
                schedule[day_str]["tasks"].append(f"{task['subject']} - {task['topic']} ({study_time} hrs) [{priority_text[task['priority']]}]")
